...
import { EDITOR_CONFIG } from '../data/config';
          ...
          <div className="lg:col-span-5 flex flex-col justify-between gap-6">
            <div className="p-8 rounded-2xl bg-[#0c0c10] border border-zinc-800/80 flex flex-col gap-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="font-mono text-base text-white font-semibold break-all">
                  {EDITOR_CONFIG.email}
                </span>
                <button
                  type="button"
                  onClick={handleCopyEmail}
                  className="p-2 rounded-lg bg-zinc-800 hover:bg-red-600 text-zinc-300 hover:text-white transition-colors shrink-0"
